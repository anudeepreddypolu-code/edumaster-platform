...
const testEndpoints = async () => {
  ...
  try {
    ...
    const studentOverview = await runStep('GET /platform/overview student', () => request('GET', '/platform/overview', null, studentToken));
    ...
    const subscriptionPlanId = studentOverview?.subscriptions?.[0]?._id;
